      ...
      <section className="flex flex-col items-center text-[1.15rem] mt-12">
        ...
        {filteredBlog.map((blog: BlogPost) => {
          return (
            <div
              key={blog.id}
              className="w-[28em] max-h-[20em] overflow-hidden mx-6 mb-6 bg-black-gradient hover:bg-blue-gradient hover:text-black rounded-lg p-4 transition-all duration-300 box-shadow "
            >
