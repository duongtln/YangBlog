    ...
    <main className="layout">
      ...
      <section>
        <div className="mt-3 text-center">
          <Link href="/">
            <h1 className="text-[3rem] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 hover:from-violet-500 hover:to-pink-500 transition duration-150 ease-out hover:ease-in">
              {' '}
              Welcome to DevBlog{' '}
            </h1>
          </Link>
