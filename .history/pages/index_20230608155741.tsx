    ...
    <main className="layout">
      ...
      <section>
        <div className="mt-3 text-center">
          <Link href="/">
            <h1 className="text-[3rem] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 hover:from-violet-500 hover:to-pink-500 ">
              {' '}
              Welcome to DevBlog{' '}
            </h1>
          </Link>
      ...
      <section className="flex flex-col items-center text-[1.15rem] mt-12">
        ...
        {filteredBlog.map((blog: BlogPost) => {
          return (
            <div
              key={blog.id}
              className="w-[28em] max-h-[20em] overflow-hidden mx-6 mb-6 bg-black-gradient rounded-lg p-4 hover:bg-neutral-500 hover:text-neutral-300 transition-all duration-300 box-shadow hover:bg-blue-gradient"
            >
